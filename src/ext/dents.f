...
struct: LINUX_DIRENT_T
  1 ds LINUX_DIRENT_T.d_ino
  1 ds LINUX_DIRENT_T.d_off
...
: LINUX_DIRENT_T.d_ino@   ( a1 --- d_ino )   LINUX_DIRENT_T.d_ino s@ ;
: LINUX_DIRENT_T.d_off@   ( a1 --- d_off )   LINUX_DIRENT_T.d_off s@ ;
...
: d_ino@    ( --- d_ino )   [ ent-buff DIRENT_T.d_ino   ]# s@ ;
: d_off@    ( --- d_off )   [ ent-buff DIRENT_T.d_off   ]# s@ ;
