...
struct: scr
  ...
  1 dq scr.buffer1          \ all chars and atributes for state of screen
  1 dq scr.buffer2          \ copy of above. difference = things to update
  1 dq scr.bar              \ pointer to a menu bar structure for screen
...
struct: win
  ...
  1 dq win.buffer           \ window buffer address
  1 dq win.screen           \ which screen this window is associated with
