...
struct: modifier
  1 dq m.counter            \ count down to next speed/shape change
  1 dq m.reset              \ initial value of counter
  1 dq m.ptr                \ pointer to item to modify
  1 dq m.delta              \ ammount to change item by
  1 dq m.upper              \ upper limit for item
  1 dq m.lower              \ lower limit for item
;struct
